...
/// <summary>
/// This transition will move the playerModel to the destination over the span of a fixed amount of time.
/// It will not adjust the orientation of the playerModel because this is very uncomfortable.
...
public class TeleportTransitionWarp : TeleportTransition
{
	...
	/// <summary>
	/// When the teleport state is entered, quickly move the playerModel to the new location
