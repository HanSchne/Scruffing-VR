...
/// <summary>
/// Teleport transitions manage the actual relocation of the playerModel from the current position and orientation
...
public abstract class TeleportTransition : TeleportSupport
{
	...
	/// <summary>
	/// When the teleport state is entered, simply move the playerModel to the new location
